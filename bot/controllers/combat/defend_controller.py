...
class DefendController(Controller):
    ...
    async def update(self) -> None:
        ...
        defenders: Units = self.ai.mediator.get_units_from_role(
        ...
        for defender in defenders:
            ...
            if ((combat_sim_result in LOSS_MARGINAL_OR_WORSE or
                 defender.position.distance_to_closest(self.ai.townhalls) > 40)
                ...
                self._defend_point = close_units.closest_to(
                    defender).position
            maneuver.add(AMove(
